...
DEFAULT_MODEL_PARAMS_TANK_FILE = CONFIG_DIR / "Default_coupled_model_params_TANK.json"      # Коэффициенты K, T, Zeta...
DEFAULT_MODEL_PARAMS_PIPE_FILE = CONFIG_DIR / "Default_coupled_model_params_PIPE.json"      # Коэффициенты K, T, Zeta...
